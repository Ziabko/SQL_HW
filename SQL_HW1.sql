...
values('Anna', 'Schwarz', 'Ingenieurin', 35, 'Y', 'Ann_Sch');

insert into staff (firstname, lastname, position, age, has_child, username)
values('John', 'Smith', 'Ingenieur', 48, 'Y', 'Jo');

insert into staff (firstname, lastname, position, age, has_child, username)
values('Milana', 'Arste', 'Ärztin', 55, 'Y', 'Mila');

insert into staff (firstname, lastname, position, age, has_child, username)
values('Greg', 'Haus', 'Arzt', 52, 'N', 'HausG');

insert into staff (firstname, lastname, position, age, has_child, username)
values('Jack', 'Doson', 'Reparieur', 29, 'Y', 'Titanik');
